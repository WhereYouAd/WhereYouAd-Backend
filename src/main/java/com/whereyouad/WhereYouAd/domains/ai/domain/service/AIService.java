...
public interface AIService {
    ...
    // 요청 내용을 PENDING 상태로 db에 바로 저장 후 reportId 반환
    Long requestAnalysis(Long userId, Long orgId, AIRequest.PeriodRequest request);

    // reportId에 해당하는 분석 리포트 반환 메서드
    AIResponse.ReportStatusResponse getReport(Long userId, Long orgId, Long reportId);
}
